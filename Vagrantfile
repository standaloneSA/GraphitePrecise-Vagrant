...
# Great tip from Jason Dixon
# # Initialize the django database from a previous dump, without any user input
# # http://obfuscurity.com/2012/04/Unhelpful-Graphite-Tip-4
# #
# # This sets the user as 'root' and the password as 'rootroot'. Sorry for the line length.
